-- Script pour la base de données du projet CurrentAccount (Compte Courant)
CREATE DATABASE currentaccount_db;
...
CREATE TABLE compte (
   ...
   type_compte VARCHAR(20) CHECK (type_compte IN ('courant')),
