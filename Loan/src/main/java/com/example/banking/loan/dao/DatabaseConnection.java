...
public class DatabaseConnection {
    ...
    static {
        try {
            ...
            dataSource.setUrl(props.getProperty("db.url").replace("currentaccount_db", "loan_db"));
            ...
            logger.info("Pool de connexions MySQL pour Loan initialisé avec succès");

        } catch (Exception e) {
            logger.error("Erreur lors de l'initialisation du pool de connexions Loan", e);
            throw new RuntimeException("Erreur d'initialisation de la base de données Loan", e);
        }
    }
