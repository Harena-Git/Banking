-- Script pour la base de données du projet Central (Consultation centrale)
-- Comme Central est le centre qui appelle les fonctions des autres projets,
-- sa base inclut toutes les tables pour des consultations potentielles,
-- mais les données réelles seront gérées via des appels de code aux autres bases.
...
CREATE TABLE compte (
   ...
   type_compte VARCHAR(20) CHECK (type_compte IN ('courant','epargne','pret')),
